...
export default function RetoursEleves() {
    ...
    return (
        <div className='pb-24'>
            <div className="flex flex-col items-center text-center py-10">
                <h1 className="text-4xl font-bold mb-4 w-full pt-16">RETOUR DES ELEVES</h1>
            </div>
            <div id="default-carousel" className="relative" data-carousel="static">
                {/* Carousel wrapper */}
                <div className="relative h-56 overflow-hidden rounded-lg md:h-96 w-full">
                    {/* Slides */}
                    {['logo 2.png', 'courbe.png', 'Seyfo.png'].map((img, index) => (
